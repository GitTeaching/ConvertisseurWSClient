 ...
 * 
 */
@WebServiceClient(name = "ConvertisseurImplService", targetNamespace = "http://tp3.ws.soa.org/", wsdlLocation = "http://localhost:1234/convertisseurws?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERTISSEURIMPLSERVICE_QNAME = new QName("http://tp3.ws.soa.org/", "ConvertisseurImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1234/convertisseurws?wsdl");
     ...
     * 
     * @return
     *     returns ConvertisseurDinarEuro
     */
    @WebEndpoint(name = "ConvertisseurImplPort")
    public ConvertisseurDinarEuro getConvertisseurImplPort() {
        return super.getPort(new QName("http://tp3.ws.soa.org/", "ConvertisseurImplPort"), ConvertisseurDinarEuro.class);
    }
     ...
     */
    @WebEndpoint(name = "ConvertisseurImplPort")
    public ConvertisseurDinarEuro getConvertisseurImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://tp3.ws.soa.org/", "ConvertisseurImplPort"), ConvertisseurDinarEuro.class, features);
    }
